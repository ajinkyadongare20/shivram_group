...
?>
	...
	<div id="footer">
		...
		<div class="row row-bottom-padded-md">
			<div class="col-md-3">
			<h3 class="section-title">Shree Shivram Group</h3>
			<p>Shree Shivram Group is dedicated to delivering quality construction and real estate solutions, combining innovation, trust, and excellence to build a better future for communities and clients.</p>
			</div>
			...
			<p>Join our mailing list to receive the latest updates, property listings, and real estate tips straight to your inbox.</p>
