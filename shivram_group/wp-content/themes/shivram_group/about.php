        ...
        <div class="row">
            ...
            <div class="col-sm-4 text-center animate-box" data-animate-effect="fadeIn">
                <div class="card fh5co-staff">
                    ...
                    <p><?php echo esc_html(get_field('about_team_person_text', get_the_ID())); ?></p>
    ...
    <div class="container">
        <div class="row g-5">
            <div class="col-lg-12 pb-5 text-start text-lg-center">
                ...
                <p><span class="text-white mb-4"><?php echo get_field('about_contact_us_text', get_the_ID()); ?></span></p>
                <?php 
